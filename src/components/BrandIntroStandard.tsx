...
interface BrandIntroStandardProps {
  tagline?: string;
}

/**
 * Standard intro for TikTok and Twitter with 2.5-second duration
 * Key features:
 * - Logo visible from frame 0 (critical for thumbnails)
 * - Spring animation for engaging brand presence
 * - Standard timing allows for more breathing room
 */
export const BrandIntroStandard: React.FC<BrandIntroStandardProps> = ({
  ...
  // Opacity is constant, but scale animates for visual interest
  const logoOpacity = 1; // Static visibility from frame 0
