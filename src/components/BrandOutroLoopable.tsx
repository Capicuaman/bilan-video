...
interface BrandOutroLoopableProps {
  cta?: string;
  handle?: string;
  website?: string;
...
/**
 * Loopable outro that keeps logo visible on the last frame for seamless video looping
 * Key differences from BrandOutroPerfected:
 * - Logo remains fully visible until the end (no fade-out)
 * - All elements stay visible on the last frame
 * - Enables seamless looping for Stories/Status features
 *
 * This creates "bookend" branding where the logo is visible on both first and last frames
 */
export const BrandOutroLoopable: React.FC<BrandOutroLoopableProps> = ({
  ...
  // Logo stays visible throughout - no fade-out at the end
  const logoOpacity = interpolate(frame, [0, 10], [0, 1], {
    extrapolateRight: "clamp", // Stays at 1, never fades out
  });
  ...
  const ctaOpacity = interpolate(frame, [fps * 1, fps * 1.3], [0, 1], {
    extrapolateRight: "clamp", // Stays visible
  });
  ...
  // Action buttons appear with handle - stay visible
  ...
  return (
    ...
    >
      ...
      >
        {/* Logo Section - Stage 1 - STAYS VISIBLE for looping */}
        <div
          style={{
            opacity: logoOpacity,
        ...
        {/* CTA Section - Stage 2 - STAYS VISIBLE for looping */}
        <div
          style={{
            opacity: ctaOpacity,
        ...
        {/* Handle - Appears with CTA - STAYS VISIBLE for looping */}
        <div
          style={{
        ...
        {/* Website URL - STAYS VISIBLE for looping */}
        <div
          style={{
            opacity: handleOpacity,
            transform: `translateY(${handleY}px)`,
        ...
        {/* Action Buttons - Maximum visibility - STAYS VISIBLE for looping */}
        {showActionPrompts && (
          <div
            style={{
