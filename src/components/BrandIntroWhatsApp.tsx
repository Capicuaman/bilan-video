...
interface BrandIntroWhatsAppProps {
  tagline?: string;
}

/**
 * WhatsApp-optimized intro with 2-second duration
 * Key features:
 * - Logo visible from frame 0 (critical for WhatsApp thumbnails)
 * - Faster animations for quick content consumption
 * - Optimized for 1080x1080 square format
 */
export const BrandIntroWhatsApp: React.FC<BrandIntroWhatsAppProps> = ({
  ...
  // This ensures WhatsApp thumbnail shows the logo
