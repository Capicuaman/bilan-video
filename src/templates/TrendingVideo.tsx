    ...
    >
      ...
      <div
        style={{
          ...
          bottom: 0,
          background:
            "radial-gradient(ellipse at 50% 30%, rgba(255,255,255,0.15) 0%, rgba(255,255,255,0) 60%)",
          pointerEvents: "none",
        }}
      />
          ...
          {scenes.map((_, i) => (
            <div
              ...
              style={{
                ...
                borderRadius: 5,
                backgroundColor:
                  i <= currentScene ? brandColor : "rgba(255,255,255,0.3)",
                boxShadow:
                  i <= currentScene ? `0 4px 12px ${brandColor}66` : "none",
              }}
            />
          ))}
        </div>
